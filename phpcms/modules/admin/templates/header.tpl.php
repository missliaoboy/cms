...
<div class="subnav">
    ...
    <?php if(isset($big_menu2)) { echo '<a class="add fb" href="'.$big_menu2[0].'"><em>'.$big_menu2[1].'</em></a>　';} else {$big_menu2 = '';} ?>
    <?php if(isset($big_menu3)) { echo '<a class="add fb" href="'.$big_menu3[0].'"><em>'.$big_menu3[1].'</em></a>　';} else {$big_menu3 = '';} ?>
